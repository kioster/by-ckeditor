				...
				},
				{
					...
					setup: function() {
						...
						var htmlToLoad = '<html dir="' + editor.config.contentsLangDirection + '"' +
							...
							'<head><style>body{margin:3px;height:95%;font: normal normal normal 14px "华文细黑", "Microsoft Yahei UI", "Microsoft Yahei", "Helvetica", "Consolas", "monospaced"}</style></head><body >' +
